...
// CREATE PRE-SAVE MIDDLEWARE TO HANDLE THE USERS' PASSWORD HASHING. REPLACES CURRENT PASSWORD WITH A HASHED ONE. SALTS SHOULD BE ADDED IN FUTURE.
UserSchema.pre('save', function (next) {
		...
		if (user.password) {
			...
			user.salt = salt;
			user.password = sha.update(this.password).digest('hex');
		}
		next();
	}
);
